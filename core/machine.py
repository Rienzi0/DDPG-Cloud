class Machine:
    ...
    def run_task_instance(self, task_instance):
        ...
        ####################
        wait_time = max(0, self.next_start_time - task_instance.start_time)
        #####################
        ...
        task_cost = self.micost * task_run_time  # 运行任务的成本
        
        return task_response_time, task_cost, task_run_time, wait_time
